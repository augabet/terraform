...
func TestFindPluginPaths(t *testing.T) {
	...
	want := []string{
		filepath.Join("test-fixtures", "current-style-plugins", "mockos-mockarch", "terraform-foo-bar-V0.0.1"),
		filepath.Join("test-fixtures", "current-style-plugins", "mockos-mockarch", "terraform-foo-bar-V1.0.0"),
...
func TestResolvePluginPaths(t *testing.T) {
	got := ResolvePluginPaths([]string{
		"/example/mockos-mockarch/terraform-foo-bar-V0.0.1",
		"/example/mockos-mockarch/terraform-foo-baz-V0.0.1",
		"/example/mockos-mockarch/terraform-foo-baz-V1.0.0",
		"/example/terraform-foo-bar",
		"/example/mockos-mockarch/terraform-foo-bar-Vbananas",
		"/example/mockos-mockarch/terraform-foo-bar-V",
		"/example2/mockos-mockarch/terraform-foo-bar-V0.0.1",
	})
	...
	want := []PluginMeta{
		{
			Name:    "bar",
			Version: "0.0.1",
			Path:    "/example/mockos-mockarch/terraform-foo-bar-V0.0.1",
		},
		{
			Name:    "baz",
			Version: "0.0.1",
			Path:    "/example/mockos-mockarch/terraform-foo-baz-V0.0.1",
		},
		{
			Name:    "baz",
			Version: "1.0.0",
			Path:    "/example/mockos-mockarch/terraform-foo-baz-V1.0.0",
		},
		{
			Name:    "bar",
			Version: "0.0.0",
		...
		},
		{
			Name:    "bar",
			Version: "bananas",
			Path:    "/example/mockos-mockarch/terraform-foo-bar-Vbananas",
		},
		{
			Name:    "bar",
			Version: "",
			Path:    "/example/mockos-mockarch/terraform-foo-bar-V",
		},
	}
